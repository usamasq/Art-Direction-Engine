...
Load Docs 00–03 and 06 (plus your filled Profile) into an assistant's persistent knowledge, add 04 or 05 depending on what you make, and give it the short system prompt in [Doc 00 §5](docs/00_System_Operating_Contract.md). [START_HERE.md](START_HERE.md) has step-by-step instructions for Claude Projects, Gemini Gems, and custom GPTs.
